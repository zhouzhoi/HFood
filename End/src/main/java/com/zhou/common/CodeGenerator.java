...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        String projectPath = System.getProperty("user.dir")+"/End";//文件存放位置
        gc.setOutputDir(projectPath + "/src/main/java");
        gc.setAuthor("zhou");//表明作者
        gc.setOpen(false);
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/hfood? useUnicode=true&characterEncoding=UTF8&useSSL=false");
                // dsc.setSchemaName("public");
                dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("root");
        dsc.setPassword("42003717");
